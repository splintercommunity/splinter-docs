...
[splinterd/packaging/splinterd.toml.example](https://github.com/splintercommunity/splinter/blob/0-4/splinterd/packaging/splinterd.toml.example)
and
[splinterd/sample_configs](https://github.com/splintercommunity/splinter/tree/0-4/splinterd/sample_configs)
...
: Specifies the path and file name for a `splinterd` configuration file, which
  ...
  [splinterd/packaging/splinterd.toml.example](https://github.com/splintercommunity/splinter/blob/0-4/splinterd/packaging/splinterd.toml.example)
  and
  [splinter/splinterd/sample_configs](https://github.com/splintercommunity/splinter/tree/0-4/splinterd/sample_configs)
  in the `splinter` repository.
